...
<body
    ...
    <nav class="bg-[#1e1e1e]/90 backdrop-blur-md px-10 py-4 shadow-lg z-10 relative flex justify-between items-center">
        <h1 class="text-3xl font-semibold">Tambah User Baru</h1>
    ...
    <div class="flex">
        <main class="flex-1 p-10 z-10">
            <div
                ...
                <h2 class="text-xl font-bold mb-4">Form Tambah User Baru</h2>
                ...
                <form method="POST" action="{{ route('register.user.store') }}">
                    ...
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 px-4 py-2 w-full rounded transition-transform hover:scale-105 font-semibold">
                        Simpan User
                    </button>
                </form>

                <div class="mt-4 text-center">
                    <a href="{{ route('pengguna') }}" class="text-blue-400 hover:underline">← Kembali ke daftar user</a>
                </div>
            </div>
        </main>
    </div>
