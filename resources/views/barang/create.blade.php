...
<body
    ...
    <nav class="bg-[#1e1e1e]/90 backdrop-blur-md px-10 py-4 shadow-lg z-10 relative flex justify-between items-center">
        <h1 class="text-3xl font-semibold">Tambah Barang</h1>
    ...
    <div class="flex flex-col min-h-screen">
        <main class="flex-1 p-10 z-10 overflow-auto">
            <div
                ...
                <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_barang" id="nama_barang"
                            class="w-full px-4 py-2 rounded bg-[#2a2a2a] text-white focus:ring-2 focus:ring-[#6aa6ff] focus:outline-none"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" id="deskripsi"
                            class="w-full px-4 py-2 rounded bg-[#2a2a2a] text-white focus:ring-2 focus:ring-[#6aa6ff] focus:outline-none"></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="gambar" class="block text-sm font-medium mb-1">Gambar Barang</label>
                        <input type="file" name="gambar" id="gambar"
                            class="w-full px-4 py-2 rounded bg-[#2a2a2a] text-white focus:ring-2 focus:ring-[#6aa6ff] focus:outline-none">
                    </div>

                    <div class="mb-4">
                        <p id="file-name" class="text-sm text-gray-300">Belum ada file yang dipilih</p>
                    </div>
                ...
                <div class="mt-4">
                    <a href="{{ route('barang.index') }}" class="text-[#6aa6ff] hover:underline">← Kembali ke daftar</a>
                </div>
