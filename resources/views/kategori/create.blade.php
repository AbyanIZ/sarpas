...
<body class="min-h-screen font-sans bg-[radial-gradient(circle_at_top_left,_#202020,_#121212)] text-white relative overflow-hidden">
    ...
    <nav class="bg-[#1e1e1e]/95 backdrop-blur-md px-8 py-4 shadow-lg z-10 relative flex justify-between items-center border-b border-[#333]/50">
        <h1 class="text-2xl font-semibold bg-gradient-to-r from-[#6aa6ff] to-[#a162e8] bg-clip-text text-transparent">
            <i class="fas fa-tags mr-2"></i>Tambah Kategori Barang
        </h1>
            ...
            <div class="max-w-md mx-auto form-card bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-8 rounded-xl shadow-lg border border-[#333]/50">
                <div class="flex items-center justify-center mb-6">
                    <div class="w-16 h-16 rounded-full bg-[#6aa6ff]/10 flex items-center justify-center mr-4">
                        <i class="fas fa-tag text-[#6aa6ff] text-2xl"></i>
                    </div>
                    <h2 class="text-xl font-bold">Form Tambah Kategori</h2>
                </div>
                ...
                <form action="{{ route('kategori.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="nama_kategori" class="block text-sm font-medium mb-2 text-gray-300">
                            <i class="fas fa-tag mr-2 text-[#6aa6ff]"></i>Nama Kategori
                        </label>
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('kategori.index') }}" class="text-[#6aa6ff] hover:underline flex items-center justify-center">
