...
<head>
    <meta charset="UTF-8">
    <title>Register Admin - SARPAS</title>
...
<body
    ...
    <div class="w-[65%] flex justify-center items-center relative z-10">
        ...
        <div
            class="w-full max-w-lg bg-[#1e1e1e]/95 backdrop-blur-lg rounded-2xl px-12 py-10 shadow-2xl z-10 animate-fadeInUp">
            <h2 class="text-[36px] font-light mb-2 h-[80px] text-center">Create Admin Account</h2>
            <p class="text-2xl mb-12 text-center">Register Admin</p>
            ...
            <form method="POST" action="/register" class="w-full">
                @csrf
                <div class="mb-8">
                    <label for="name" class="block text-sm text-[#ccc] mb-1">Name</label>
                ...
                <div class="mb-8">
                    <label for="password_confirmation" class="block text-sm text-[#ccc] mb-1">Confirm Password</label>
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('login') }}">
                        <button type="button"
                            class="text-lg text-[#6aa6ff] hover:underline transition duration-200">Already have an
                            account?</button>
                    </a>
                    <button type="submit"
