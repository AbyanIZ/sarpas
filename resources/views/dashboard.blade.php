...
<head>
    ...
    <style>
        ...
        .action-card:hover { transform: translateY(-3px); background-color: #2a2a2a; }
    </style>
</head>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8 z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div class="card-hover bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl shadow-lg border border-[#333]/50">
                    <div class="flex items-center mb-4">
                        <i class="fas fa-user-shield text-[#6aa6ff] mr-3 text-xl"></i>
                        <h3 class="text-lg font-semibold text-gray-300">Jumlah Admin</h3>
                    </div>
                    <p class="text-4xl font-bold text-[#6aa6ff]">{{ $jumlahAdmin }}</p>
                </div>
                <div class="card-hover bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl shadow-lg border border-[#333]/50">
                    <div class="flex items-center mb-4">
                        <i class="fas fa-users text-[#6aa6ff] mr-3 text-xl"></i>
                        <h3 class="text-lg font-semibold text-gray-300">Jumlah User</h3>
                    </div>
                    <p class="text-4xl font-bold text-[#6aa6ff]">{{ $jumlahUser }}</p>
                </div>
                <div class="card-hover bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl shadow-lg border border-[#333]/50">
                    <div class="flex items-center mb-4">
                        <i class="fas fa-boxes text-[#6aa6ff] mr-3 text-xl"></i>
                        <h3 class="text-lg font-semibold text-gray-300">Jumlah Barang</h3>
                    </div>
                    <p class="text-4xl font-bold text-[#6aa6ff]">{{ $jumlahBarang }}</p>
                </div>
            </div>
        </main>
    </div>
