    ...
    <div class="flex">
        <aside class="w-64 bg-[#181818]/80 py-10 px-6 border-r border-[#333] min-h-screen relative z-10">
            <ul class="space-y-4">
                ...
                <li><a href="{{ route('laporan') }}" class="block py-5 px-5 rounded bg-[#2f2f2f]">Laporan</a></li>
            </ul>
        </aside>

        <main class="flex-1 p-10 z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                <div class="bg-[#1f1f1f]/80 p-6 rounded-2xl shadow-lg border border-[#333] hover:bg-[#2a2a2a] transition">
                    <h2 class="text-xl font-bold mb-4">Laporan Stok Barang</h2>
                ...
                <div class="bg-[#1f1f1f]/80 p-6 rounded-2xl shadow-lg border border-[#333] hover:bg-[#2a2a2a] transition">
                    <h2 class="text-xl font-bold mb-4">Laporan Pengembalian</h2>
                    <p class="text-sm text-gray-400">by one deck</p>
                </div>
            </div>
        </main>
