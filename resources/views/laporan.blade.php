    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-[#181818]/90 py-8 px-6 border-r border-[#333]/50 min-h-screen relative z-10 backdrop-blur-sm">
            <ul class="space-y-3">
                ...
                <li>
                    <a href="{{ route('laporan') }}" class="flex items-center py-4 px-5 rounded-lg bg-gradient-to-r from-[#2f2f2f] to-[#2f2f2f]/70 hover:from-[#333] hover:to-[#333]/70 transition shadow-md sidebar-item">
        ...
        <main class="flex-1 p-8 z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                <!-- Laporan Stok Barang -->
                <div class="report-card bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl border border-[#333]/50">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="#" class="text-sm text-[#6aa6ff] hover:underline flex items-center">
                            Lihat Laporan <i class="fas fa-chevron-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="report-card bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl border border-[#333]/50">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="#" class="text-sm text-[#5abf6a] hover:underline flex items-center">
                            Lihat Laporan <i class="fas fa-chevron-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="report-card bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl border border-[#333]/50">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="#" class="text-sm text-[#e8a162] hover:underline flex items-center">
                            Lihat Laporan <i class="fas fa-chevron-right ml-1"></i>
                        </a>
                    </div>
                </div>

                <!-- Template for Additional Reports -->
                <div class="report-card bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] p-6 rounded-xl border border-[#333]/50">
                    <div class="flex items-center mb-4">
                    ...
                    <div class="mt-4 flex justify-end">
                        <a href="#" class="text-sm text-[#a162e8] hover:underline flex items-center">
                            Lihat Laporan <i class="fas fa-chevron-right ml-1"></i>
                        </a>
                    </div>
                </div>
